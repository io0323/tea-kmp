...
fun GuidanceBlock() {
    Column {
        Text(
            text = stringResource(id = R.string.delete_account_form__guidance),
        ...
        Box(
            ...
            Column(
                ...
                Row(
                    ...
                    Text(
                        text = stringResource(id = R.string.delete_account_form__caution_title),
                ...
                Text(
                    text = stringResource(id = R.string.delete_account_form__caution_text),
                    color = Colors.Error,
