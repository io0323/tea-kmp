...
fun FeedBackBlock(
    ...
    Column {
        Row(
            ...
            Text(
                text = stringResource(R.string.delete_account_form__feed_back),
        ...
        OutlinedTextField(
            ...
            placeholder = {
                Text(
                    text = stringResource(R.string.delete_account_form__place_holder),
        ...
        if (isError) {
            Text(
                text = stringResource(id = R.string.delete_account_form__feed_back_input_error),
                color = Colors.Error,
