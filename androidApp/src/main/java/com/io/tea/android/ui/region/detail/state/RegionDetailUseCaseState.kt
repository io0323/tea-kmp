...
sealed class RegionDetailUseCaseState {
    data object Initial : RegionDetailUseCaseState()
    data object Loading : RegionDetailUseCaseState()
    data class Success(val data: RegionDetailModel) : RegionDetailUseCaseState()
    data class Failure(val errorMessage: String) : RegionDetailUseCaseState()
}
