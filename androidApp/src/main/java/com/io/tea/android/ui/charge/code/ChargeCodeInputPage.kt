...
@Composable
internal fun ChargeCodeInputPage(
    viewModel: ChargeCodeInputViewModel = koinViewModel(),
    ...
    val model by viewModel.codeInputModelStateFlow.collectAsStateWithLifecycle(lifecycleOwner)
