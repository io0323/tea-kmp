...
@Composable
internal fun PaymentCompletePage(
    viewModel: PaymentCompleteViewModel = koinViewModel(),
    ...
    val paymentCompleteModel by viewModel.paymentCompleteModelStateFlow.collectAsStateWithLifecycle(
        lifecycleOwner
    )
    ...
    PaymentCompleteScreen(
        ...
        onRegionTopClick = viewModel::onRegionTopClick
    )
}
