...
@Composable
internal fun ChargeCodeConfirmPage(
    viewModel: ChargeCodeConfirmViewModel = koinViewModel(),
    ...
    val chargeCodeConfirmModel by viewModel.chargeCodeConfirmModelStateFlow.collectAsStateWithLifecycle(
